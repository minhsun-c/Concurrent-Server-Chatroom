...
#endif // HOMEWORK2_FUNCTION
#ifdef HOMEWORK3_FUNCTION

static void gyell_broadcast()
{
    int uid, port, pid;
    char name[100], ip[20];
    char userFile[20] = "tmp/usrList.txt";
...
#endif // HOMEWORK2_FUNCTION
#ifdef HOMEWORK3_FUNCTION
        if (strncmp(cmd->data.full_path, "./bin/gyell", strlen("./bin/gyell")) == 0)
        {
            gyell_broadcast();
        }
#endif // HOMEWORK3_FUNCTION
